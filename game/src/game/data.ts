...
export const QUESTS: Record<QuestState, QuestDefinition> = {
  talkKeeper: {
    ...
    actionLabel: "Create source truth",
  ...
  meetArchivist: {
    ...
    targetId: "archivist",
    actionLabel: "Gather trie proofs",
  ...
  matchBeacon: {
    ...
    actionLabel: "Match into consensus",
  ...
  verifyHeader: {
    ...
    actionLabel: "Verify header branch",
  ...
  claimLoan: {
    ...
    targetId: "sun_lender",
    actionLabel: "Issue verified loan",
